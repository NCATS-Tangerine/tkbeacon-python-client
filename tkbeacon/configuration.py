...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of tkbeacon.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the tkbeacon.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = tkbeacon.Configuration(
        signing_info = tkbeacon.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("tkbeacon")
