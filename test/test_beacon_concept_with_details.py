...
import tkbeacon
from tkbeacon.models.beacon_concept_with_details import BeaconConceptWithDetails  # noqa: E501
...
class TestBeaconConceptWithDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tkbeacon.models.beacon_concept_with_details.BeaconConceptWithDetails()  # noqa: E501
        if include_optional :
            return BeaconConceptWithDetails(
                ...
                details = [
                    tkbeacon.models.beacon_concept_detail.BeaconConceptDetail(
                        tag = '0', 
                        value = '0', )
                    ]
            )
