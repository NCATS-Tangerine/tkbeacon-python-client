...
class ExactMatchResponse(object):
    ...
    def __init__(self, id=None, within_domain=None, has_exact_matches=None, local_vars_configuration=None):  # noqa: E501
        """ExactMatchResponse - a model defined in OpenAPI"""  # noqa: E501
