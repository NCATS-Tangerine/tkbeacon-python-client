...
class BeaconPredicate(object):
    ...
    def __init__(self, edge_label=None, relation=None, description=None, frequency=None, local_vars_configuration=None):  # noqa: E501
        """BeaconPredicate - a model defined in OpenAPI"""  # noqa: E501
