...
CLIENT_SPECIFICATION_FILE_PATH="./knowledge-beacon-api_1-3-0.yaml"
CLIENT_OUTPUT_DIR="tkbeacon"
CLIENT_PROJECT_NAME="${PROJECT_NAME}_${CLIENT_OUTPUT_DIR}"
CLIENT_PACKAGE_NAME="tkbeacon"
CLIENT_PACKAGE_VERSION="1.3.0"
CLIENT_PACKAGE_URL="https://github.com/NCATS-Tangerine/tkbeacon-python-client"

#
# This project doesn't have a server
#
...
#SERVER_PACKAGE_NAME="ara_server"
#SERVER_PACKAGE_VERSION="0.9.2"
#SERVER_PACKAGE_URL="https://github.com/ncats/translator_modules/tree/master/server"
#SERVER_PORT=8080
...
usage() {
# note that the 'server' was removed from the usage; put back in later if and as needed
