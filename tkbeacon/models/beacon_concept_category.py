...
class BeaconConceptCategory(object):
    ...
    def __init__(self, category=None, local_category=None, description=None, frequency=None, local_vars_configuration=None):  # noqa: E501
        """BeaconConceptCategory - a model defined in OpenAPI"""  # noqa: E501
