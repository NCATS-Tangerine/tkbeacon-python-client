...
class BeaconStatement(object):
    ...
    def __init__(self, id=None, subject=None, predicate=None, object=None, local_vars_configuration=None):  # noqa: E501
        """BeaconStatement - a model defined in OpenAPI"""  # noqa: E501
